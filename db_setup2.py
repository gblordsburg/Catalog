...
#User class taken from github repo udacity/APIs/Lesson_4/02_Adding Users and Logins/models.py
#used in the Fullstack Nanodegree-The Backend: Databases & Applications-Lesson 17 Securing your API.
class User(Base):
    __tablename__ = 'user'
